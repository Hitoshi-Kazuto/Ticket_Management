...
const AssignStaffPopup = ({ isOpen, ticket, onClose, dropdownValues }) => {
    ...
    const handleSubmit = async (e) => {
        ...
        try {
            const response = await axios.put(`http://13.51.193.200:3000/ticket/helpdesk-access/assign-staff/${ticket.ticket_id}`, formData);
                ...
                <form onSubmit={handleSubmit}>
                    ...
                    <div className="flex flex-wrap -mx-3 mb-4">
                        <div className="w-full px-3">
                            ...
                            <a href={`http://localhost:3000/ticket/${ticket.file_path}`} target="_blank" rel="noopener noreferrer">
                                {formData.File_Path}
                            </a>
