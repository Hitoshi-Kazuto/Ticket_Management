...
const PopupForm = ({ isOpen, onClose, onSubmit, error }) => {
    ...
    return (
        <div className="fixed inset-0 bg-gray-600 bg-opacity-50 flex items-center justify-center">
            ...
            <span className="self-right text-xl mb-8 font-bold whitespace-nowrap text-gray-900">ADD SOFTWARE</span>
            <hr className='px-3 mb-4 my-4'></hr>
                ...
                <form onSubmit={handleSubmit}>
                    <div className="mb-4">
                        <label className="uppercase tracking-wide text-gray-700 text-sm font-bold mb-2">Software Name<span className='text-red-700 font-bold text-sm'>*</span></label>
                        <input
                            type="text"
                            name="Software_Name"
