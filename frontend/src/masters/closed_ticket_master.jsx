...
const TicketMaster = () => {
    ...
    const fetchDataBasedOnRoles = async () => {
        ...
        switch (role) {
            case 'Admin':
                apiUrl = 'http://13.51.193.200:3000/ticket/closed-ticket/admin-access';
                break;
            case 'Partner':
                apiUrl = `http://13.51.193.200:3000/ticket/closed-ticket/user-access/${username}`;
                break;
            case 'Orbis':
                apiUrl = `http://13.51.193.200:3000/ticket/closed-ticket/user-access/${username}`;
                break;
            case 'Helpdesk':
                apiUrl = 'http://13.51.193.200:3000/ticket/closed-ticket/helpdesk-access'
    ...
    return (
        <div>
            ...
            <div className="overflow-x-auto shadow-md absolute right-0 w-5/6">
                <p className=' bg-gray-200 border-gray-200 p-3 m-0 dark:bg-gray-800 relative self-right text-xl font-semibold whitespace-nowrap dark:text-gray-400'>Closed Tickets</p>
                <input
                    type="text"
                    id="search"
                    value={searchQuery}
